        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-6">
          <div className="text-left">
            <h1 className="text-3xl font-bold text-neutral">
              এক্সপ্লোর সাপোর্ট গ্রুপ
            </h1>
            <p className="text-neutral/60">
              আপনার জন্য সঠিক কমিউনিটিটি খুঁজে নিন
            </p>
          </div>
          ...
          >
            ...
            />
            <Search
              className="absolute left-3 top-3 text-neutral/40"
              size={20}
            />
              ...
              >
                <figure className="relative overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3">
                    <div className="badge badge-secondary shadow-md font-medium">
                      {group.category}
                    </div>
                  </div>
                </figure>
                <div className="card-body">
                  <h2 className="card-title text-neutral font-bold">
                    {group.title}
                  </h2>
